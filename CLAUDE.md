...
**Die Fußzeile ist eine Zeile:** `Copyright Prof. Dr. Maik Drozdzynski, 2026 · build 0.0.57`.
...
`<span class='build'>build 0.0.57</span>`. Die einfachen Anführungszeichen sind Absicht — auf
